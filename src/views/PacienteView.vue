<template>
    <div class="signUp_user">
        <div class="container_signUp_user">
            <h2>Paciente</h2>
            <form>
                <input type="int" v-model="paciente.id" placeholder="ID">
                <br>
                ...
                <input type="text" v-model="paciente.fecha" placeholder="Fecha Nacimiento">
                <br>

                <input type="int" v-model="paciente.iduser" placeholder="IDUSER">
                <br>
